    ...
    <div className="flex flex-col items-center w-full h-full gap-4 px-10 py-4">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        <div className="flex flex-col w-full">
          ...
          <FieldResolution label="Content" rightChild={<Textarea />} />
          <FieldResolution
            label="Note"
            rightChild={<Textarea />}
            isLast={true}
        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col gap-2 w-1/2">
            <div className="flex items-center gap-1">
              <span className="w-1/4 flex justify-end pr-2">Category</span>
              <Select>
            ...
            <div className="flex gap-1">
              <span className="w-1/4 flex justify-end pr-2">Description</span>
              <Textarea className="w-3/4" />
            </div>
            <div className="flex gap-1">
              <span className="w-1/4 flex justify-end pr-2">Amount</span>
